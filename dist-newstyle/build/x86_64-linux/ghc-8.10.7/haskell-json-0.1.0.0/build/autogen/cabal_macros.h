...
/* package haskell-json-0.1.0.0 */
#ifndef VERSION_haskell_json
#define VERSION_haskell_json "0.1.0.0"
#endif /* VERSION_haskell_json */
#ifndef MIN_VERSION_haskell_json
#define MIN_VERSION_haskell_json(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_json */
...
#define CURRENT_PACKAGE_KEY "haskell-json-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-json-0.1.0.0-inplace"
